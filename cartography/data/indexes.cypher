...
CREATE INDEX ON :CodeguruAssociation(id);
CREATE INDEX ON :CodeguruCodereview(id);
CREATE INDEX ON :CodeguruRecommendation(id);
CREATE INDEX ON :CodeguruRecommendationFeedback(id);
