...
- [CodeguruAssociation](#codeguruassociation)
  - [Relationships](#relationships-75)
- [CodeguruCodereview](#codegurucodereview)
  - [Relationships](#relationships-76)
- [CodeguruRecommendation](#codegururecommendation)
  - [Relationships](#relationships-77)
- [CodeguruRecommendationFeedback](#codegururecommendationfeedback)
...
Representation of an AWS CODEGURU [Repository Association](https://docs.aws.amazon.com/codeguru/latest/reviewer-api/API_RepositoryAssociation.html)
...
- CodeguruAssociation are a resource under the AWS Account.

        ```
        (AWSAccount)-[RESOURCE]->(CodeguruAssociation)
        ```

- CodeguruCodereview can be attached to the CodeguruAssociation.

        ```
        (CodeguruAssociation)-[:HAS_CODEREVIEW]->(CodeguruCodereview)
        ```

## CodeguruCodereview

Representation of an AWS CODEGURU CODE REVIEW [Code Review](https://docs.aws.amazon.com/codeguru/latest/reviewer-api/API_CodeReviewSummary.html)
...
| **id** | The Amazon Resource Name (ARN) of the CodeReview object |
...
- CodeguruCodereview can be attached to the CodeguruAssociation.
        ...
        (CodeguruAssociation)-[:HAS_CODEREVIEW]->(CodeguruCodereview)
        ```
- CodeguruRecommendation can be attached to the CodeguruCodereview.

        ```
        (CodeguruCodereview)-[:HAS_RECOMMENDATION]->(CodeguruRecommendation)
        ```

## CodeguruRecommendation

Representation of an AWS CODEGURU RECOMMENDATION [RecommendationSummary](https://docs.aws.amazon.com/codeguru/latest/reviewer-api/API_RecommendationSummary.html)
...
- CodeguruRecommendation can be attached to the CodeguruCodereview.
        ...
        (CodeguruCodereview)-[:HAS_RECOMMENDATION]->(CodeguruRecommendation)
        ```
- CodeguruRecommendationFeedback can be attached to the CodeguruRecommendation.

        ```
        (CodeguruRecommendation)-[:HAS_RECOMMENDATION_FEEDBACK]->(CodeguruRecommendationFeedback)
        ```

## CodeguruRecommendationFeedback

Representation of an AWS CODEGURU RECOMMENDATION [RecommendationFeedback](https://docs.aws.amazon.com/codeguru/latest/reviewer-api/API_RecommendationFeedback.html)

| Field | Description |
|-------|-------------|
| reactions | List for storing reactions |
| **id** | The recommendation ID that can be used to track the provided recommendations |
